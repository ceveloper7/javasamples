...
public class QueryTest {
    ...
    // get all books by a particular publisher
    ...
    // arrays que se cargan con las consultas de authors y publisjers en la BD
    ...
    public static void changePrices(Connection conn) throws SQLException
    {
        ...
        stat.setString(2, publisher);
        // executeUpdate() for UPDATE Statements
