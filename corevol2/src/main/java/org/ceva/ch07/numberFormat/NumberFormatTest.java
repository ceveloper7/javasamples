package org.ceva.ch07.numberFormat;
...
class NumberFormatFrame extends JFrame
{
    ...
    private JRadioButton compactShortRadioButton = new JRadioButton("Compact Short");
    private JRadioButton compactLongRadioButton = new JRadioButton("Compact Long");
